...
namespace Devolon\EazyBreak\Tests;

use Devolon\Payment\DevolonPaymentServiceProvider;
use Devolon\EazyBreak\DevolonEazyBreakServiceProvider;
...
abstract class EazyBreakTestCase extends TestCase
{
    use RefreshDatabase;
    ...
    {
        return [DevolonPaymentServiceProvider::class, DevolonEazyBreakServiceProvider::class];
    }
